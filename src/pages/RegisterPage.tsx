    ...
    <div className="min-h-screen flex items-center justify-center px-4 py-12">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-[var(--color-text-muted)] mt-2">Hesabınızı oluşturun</p>
        </div>
        ...
        <div className="bg-[var(--color-surface)] rounded-2xl shadow-xl p-8 border border-[var(--color-border)]">
          {success ? (
            <div className="text-center py-8">
              ...
              <h2 className="text-xl font-semibold text-[var(--color-text)] mb-2">Hesap Oluşturuldu!</h2>
          ...
          {!success && (
            <div className="mt-6 text-center">
              <p className="text-[var(--color-text-muted)]">
                ...
                <Link to="/login" className="text-[var(--color-primary)] hover:text-[var(--color-primary-dark)] font-medium">
                  Giriş yapın
                </Link>
              </p>
            </div>
